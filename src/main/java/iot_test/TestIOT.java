...
public class TestIOT extends Commons {
    ...
    @Test
    // Verify cookies in the footer, and on clicking ‘Learn more’, the pop-up contains the string ‘Cookie and Privacy Settings’
    public void validateCookieFooter() throws Exception {
        ...
        File DestFile = new File("./logos/test.png");
